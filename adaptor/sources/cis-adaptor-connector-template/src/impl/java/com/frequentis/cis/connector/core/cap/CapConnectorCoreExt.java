...
public class CapConnectorCoreExt {
	...
	public CapConnectorCoreExt() throws CISConfigException {
	...
	public void notify(Object msg, Map<DEParameters, String> deParameters, boolean dontEnvelope) throws CISInvalidObjectException, CISCommunicationException {
		...
		if (msg instanceof String) {
			...
			throw new CISInvalidObjectException("Given Object is no valid CAP Message!");
		}
		...
		try {
			...
			log.error("notify: " + e);
			throw new CISInvalidXMLObject("Message is no valid CAP message!",e);
		}
		
		try {
			CISXMLContent xmlCont = new CISXMLContent();
			xmlCont.setEmbeddedXMLContent(capMsgStr);
			core.notify(CoreConstants.MSGTYPE_CAP, xmlCont, deParameters, false);
