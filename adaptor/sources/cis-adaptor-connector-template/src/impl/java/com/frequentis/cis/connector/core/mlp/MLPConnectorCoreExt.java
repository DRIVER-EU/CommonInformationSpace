...
public class MLPConnectorCoreExt {
	...
	public MLPConnectorCoreExt() throws CISConfigException {
	...
	public void notify(Object msg, Map<DEParameters, String> deParameters, boolean dontEnvelope) throws CISInvalidObjectException, CISCommunicationException {
		...
		if (msg instanceof String) {
			...
			throw new CISInvalidObjectException("Given Object is no valid MLP Message!");
		}
		
		try {
			CISXMLContent xmlCont = new CISXMLContent();
			xmlCont.setEmbeddedXMLContent(msgStr);
			core.notify(CoreConstants.MSGTYPE_MLP, xmlCont, deParameters, false);
