...
public class OtherContentConnectorCoreExt {
	...
	public OtherContentConnectorCoreExt() throws CISConfigException {
	...
	public void notify(String msgType, Object msg, Map<DEParameters, String> deParameters, boolean dontEnvelope) throws CISInvalidObjectException, CISCommunicationException {
		...
		try {
			if (msgType.equalsIgnoreCase(CoreConstants.MIME_TYPE_KMZ)) {
				...
				core.notify(CoreConstants.MSGTYPE_KMZ, otherCont, deParameters, false);
