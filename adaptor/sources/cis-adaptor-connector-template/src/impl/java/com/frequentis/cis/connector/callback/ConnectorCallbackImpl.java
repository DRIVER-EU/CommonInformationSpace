...
public class ConnectorCallbackImpl implements ConnectorCallback {
	...
	ConnectorCore coreConnector = null;

	/**
	 * Default Constructor
	 */
	public ConnectorCallbackImpl() throws CISConfigException {
		coreConnector = new ConnectorCoreImpl();
	}
	...
	public void msgReceived(CallbackMessage msg) {
		...
		try {
			coreConnector.msgReceived(msg.getPayload());
		} catch (Exception e) {
