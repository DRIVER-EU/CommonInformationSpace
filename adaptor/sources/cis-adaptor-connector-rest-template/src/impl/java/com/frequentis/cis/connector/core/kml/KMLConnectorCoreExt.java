...
public class KMLConnectorCoreExt {
	...
	public void notify(Object msg, Map<DEParameters, String> deParameters, boolean dontEnvelope) throws InvalidObjectException {
		...
		if (msg instanceof String) {
			...
			throw new InvalidObjectException("Given Object is no valid KML Message!");
		}
		
		try {
			CISXMLContent xmlCont = new CISXMLContent();
			xmlCont.setEmbeddedXMLContent(kmlMsg);
			restSender.notify(CoreConstants.MSGTYPE_KML, xmlCont, null, false);
