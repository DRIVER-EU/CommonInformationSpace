...
1. Ensure you have maven on your computer and in the path. If not, you can download this from [here](https://maven.apache.org/download.cgi).
2. Checkout the files ```CISCore-1.0.jar / CISCore-1.0.pom & caplibrary-r11.jar / caplibrary-r11.pom & CISExceptions-1.0.jar / CISExceptions-1.0.pom & CISEMSILibrary-1.0.jar / CISEMSILibrary-1.0.pom```
3. Open a command and run the following command for CISCore & caplibrary & CISExceptions & CISEMSILibrary:
```
mvn install:install-file -Dfile=<path-to-file> -DpomFile=<path-to-pomfile>
```
Check your local maven repository if the files were installed.
